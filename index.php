    ...
    <body>
        ...
        <nav class="bg-dark navbar navbar-expand-lg navbar-dark bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="bi bi-list white"></span></button>
        ...
        <header class="bg-dark py-5 header_bg_img" style="background-image:  url('./assets/images/banner.png')">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">팝업 스토어 샘플 텍스트</h1>
                    <p class="lead fw-normal text-white-50 mb-0">당신이 원하는 팝업스토어를 꾸미세요!</p>
                </div>
            </div>
        </header>
        <!-- Section-->
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/detail.php?id=1">구매 옵션</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">구매 옵션</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
